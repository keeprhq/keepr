...
export function GitLabIcon({ size = 12 }: { size?: number }) {
  // viewBox tightened to the art bounds — the source SVG is 380×380 but
  // only the center ~160px contains geometry, which made the rendered icon
  // visibly smaller than GitHub/Slack/Jira next to it in Settings and the
  // sidebar.
  return (
    <svg width={size} height={size} viewBox="108 110 160 160" aria-hidden>
